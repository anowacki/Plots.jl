...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(expand_extrema!),Axis,Vector{Float64}})
    ...
    isdefined(Plots, Symbol("#10#14")) && Base.precompile(Tuple{getfield(Plots, Symbol("#10#14")),UnitRange{Int64}})
